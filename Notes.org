...
#+LATEX_HEADER: \usepackage{commonunicode}
...
*** Typo: missing ~'s
    ...
    :END:
    basis vectors in [b] should be $\tilde{e}_1, \tilde{e}_2$.  The poins is that when e_2
