...
* Derivatives
  ...
  | "differential""        | D or d        | -      | -                       | -       | -   |
  | Lie derivative         |               |        | use intrinsic/covariant |         |     |
  | directional derivative | \nabla_t            | D_X     | \nabla_v                      | v_p[f]  |     |
  | covariant/intrinsic    | \nabla             | \nabla      | D_v                      |         |     |
...
* /O'Neill - Elementary Differential Geometry/
  ...
  :NOTER_PAGE: 33
  :END:
* /Covariant derivatives of basis functions_RJP/
  :PROPERTIES:
  :NOTER_DOCUMENT: Chapter_08/Covariant derivatives of basis functions_RJP.pdf
  :NOTER_PAGE: 1
  :END:
